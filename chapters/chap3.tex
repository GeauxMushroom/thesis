...
simulations. The details of the implementation can be found in Ref \onlinecite{Fang-Feng-Tam-etal-2013}. 
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{img/chi.pdf}% 
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{img/binder.pdf}% Here is how to import EPS art
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{img/corr.pdf}% Here is how to import EPS art
...
\begin{figure}[ht]
  \centering
\includegraphics[width=0.8\textwidth]{img/r12.pdf}% Here is how to import EPS art
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{img/eq_l10.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{img/R12_l10_samples.pdf}
...
$R_{12}$ does show crossing behavior for relatively small system sizes ($L=6,8,10$). We did perform simulations for larger system sizes, 
but we are not confident that those simulations reach equilibrium since the data is too noisy in particular for $R_{12}$.
With the present system sizes and the statistical error bar, a rigorous data analysis does not seem to deliver unbiased information. 
This situation is rather discouraging, as simulations at this low temperature for much larger system sizes 
using the present method are daunting.  
...
We also study the distribution of the susceptibilities. We calculated the susceptibility
for each disorder realization, and plotted the histogram at the lowest temperature,
$\beta=1.8$.
The distribution of susceptibilities are highly skewed, and dominated by rare
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{img/chi_1_dist.pdf}
...
mean, but we cannot reach a definitive conclusion with this method either.

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{img/r12_gmean_h01.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{img/l16_r12.pdf}
