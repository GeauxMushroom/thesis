...
first found by Cannella and Mydosh(1972), indicating a transition to a state of 
...
has been debated. Below the upper critical dimension ($d<6$), especially in three 
dimensions, the nature of the spin glass phase is still not clear. The main 
competing picture is the Droplet picture, proposed by Fisher and Huse, in which 
...
Katzgraber et.al. studied the existence of a line of transitions of an Ising spin glass 
in a magnetic field-known as the de Almeida-Thouless line-using one-dimensional 
power-law diluted Ising spin-glass models. Their results for the model 
corresponding to a three-dimensional system are consistent with there being no 
de Almeida-Thouless line.

The Janus collaboration built a special purpose computer with FPGA to simulate
...
to the c-axis of the tetragonal crystalline structure of the lattice. Ka-Ming Tam
et.al showed that a SG transition at nonzero temperature occurs in a realistic
