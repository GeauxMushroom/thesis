...
\caption[]{Performance comparison of the unified/separated/shuffled storage allocation schemes for
  a $16^3$ lattice. The definition of  a transaction is a sequence of  7 loads and a store that serve the spin update.\footnotemark}
\label{table_allocation}
\end{table}

\footnotetext{These numbers are calculated by measuring the difference of execution time of
a memory load and the execution time of assigning a constant to the variable.}
